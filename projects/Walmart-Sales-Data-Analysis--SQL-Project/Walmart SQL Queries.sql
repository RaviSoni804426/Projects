...
ALTER TABLE sales 
MODIFY rating DECIMAL(4,1);

LOAD DATA INFILE 'C:/ProgramData/MySQL/MySQL Server 9.2/Uploads/Walmart Sales Data.csv.csv'
INTO TABLE sales
...
UPDATE sales
JOIN (SELECT AVG(total) AS avg_total FROM sales) AS t
ON 1=1
